MODULE Param
  ...
  CHARACTER (LEN=*), PARAMETER :: simFileName = "dssi"
  ...
  INTEGER, PARAMETER :: DSSIsz = 92
  REAL(wp), PARAMETER :: kappaDSSI = kappa
  ...
  REAL(wp), PARAMETER :: psi_wave1_end = 1.35_wp ! 1.0_wp / pp
  ...
  REAL(wp), PARAMETER :: initB = 0.6_wp * 52_wp
